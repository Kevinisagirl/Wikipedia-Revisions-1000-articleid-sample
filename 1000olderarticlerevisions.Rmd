...
ggplot(data = article_count_by_month, aes(x=as.integer(format(as.yearmon(first), "%m")), y = count)) + geom_line(size = 0.5) + ylab("Number of Articles First Revised") + xlab("Date of First Revision") + facet_grid(. ~ format(as.yearmon(first), "%Y")) + scale_x_discrete(breaks=c(1:12))
